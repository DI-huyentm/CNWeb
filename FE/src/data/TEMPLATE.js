  ...
  profile: {
    ...
    contacts: [
      { icon: PhoneIcon, label: "Phone", value: "(978) 123-4567" },
      {
        icon: EmailIcon,
        label: "Email",
        value: "sara_friends@student.uml.edu",
      },
    ...
    skills: [
      ...
      { category: "Scripting Languages:", skills: "Bash Shell, HTML" },
      {
        ...
        skills: "Unix/Linux, Mac OSX, Windows XP & Vista",
      },
      {
        category: "Documentation:",
        skills: "MS Word, Excel, PowerPoint & Visio",
      },
    ],
    socialMedia: [
    ...
    experience: [
      ...
      },
      {
        ...
        description:
          "Monitor lab activity for up to 50 users at a time. Perform basic hardware/software troubleshooting.",
      },
      {
        title:
          "Technical Support Specialist / Commonwealth of Massachusetts, Information Technology Division",
        date: "Summer 20xx",
        description:
          "Supported and hosted state-wide agency systems and messaging services on platforms including HP Unix, Linux, MVS, and Windows Active Exchange. Assisted with server builds and maintenance. Reviewed, installed, set up, and assisted with active synching of BlackBerry mobile devices to Windows Email Exchange server.",
      },
      {
        title: "Asperger’s Association of New England",
        date: "Jun. 20xx - Aug. 20xx",
        description:
          "Volunteered one day a week with data entry and basic financial accounting projects",
      },
      {
        title: "Lifeguard",
